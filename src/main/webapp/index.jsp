...
<%-- exception. --%>
<%@ page session="true"%> 
<% session.setMaxInactiveInterval(1800); %> <%--session 정보자체가 1800초동안 유지된다 (분단위로 하고 싶으면 *60을 뒤에 붙여준다, 0을 적으면 무제한이 된다)--%> 
<%-- 스크립틀릿 --%>
<%-- 자바를 사용하기 위한 공간 --%>
<% for(int i = 0; i < 5; i += 1); %>
...
<body>
<%-- 액션 태그중 URL을 만들어내는 태그 대부분에 사용이 가능한 녀석이다 --%>
